...
//================================Shifts===========================================================
							...
							while( $id=mysqli_fetch_array($smes)){
								$num_shifts_asked_query="select shiftasked from ApprovedUser join Fairness where Fairness.user_id=ApprovedUser.id and A.user_id=".$id[0]." ;";
								...
								echo "$id[1] - asked=$num_asked got=$num[0] <br>";
